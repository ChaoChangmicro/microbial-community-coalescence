...
custom_colors <- c("#2c7bb6", "#abd9e9", "#a65628","#31a354", "#74c476", "#e41a1c", "#377eb8", "#4daf4a", "#ffff33","#b2df8a", "#984ea3", "#ff7f00", "#377eb8",  "#f781bf", "#66c2a5", "#999999", "#fc8d62", "#8da0cb", "#a6d854", "#ffd92f")
...
p1
write.csv(all,file = "summer_taxa_trans.csv")
ggsave("summer_taxa_trans.pdf",plot = p1,width = 400,height = 200,units = "mm")
...
p2
ggsave("summer_relative_trans.pdf",plot = p2,width = 400,height = 200,units = "mm")
...
ggsave("summer_abundance.pdf",plot = p3,width = 600,height = 400,units = "mm")
...
p
getwd()
ggsave("summer_all.pdf",plot = p,width = 600,height = 400,units = "mm")
...
ggsave("summer_nich.pdf",plot = p,width = 400,height = 200,units = "mm")
