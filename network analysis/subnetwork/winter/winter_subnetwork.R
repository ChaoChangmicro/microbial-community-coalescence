...
adjacency_unweight <- read.csv('winter_network.csv', row.names = 1, check.names = FALSE)
...
otu <- read.csv('winter.csv', row.names = 1, check.names = FALSE)
...
head(sub_graph_stat) 
mean(node.vul)
write.csv(sub_graph_stat, 'winter_subnet_top_new.csv', quote = FALSE)
