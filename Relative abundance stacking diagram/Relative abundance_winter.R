...
phylum_top10 <- read.csv('winter_top10.csv', row.names = 1, stringsAsFactors = FALSE, check.names = FALSE)
...
group <- read.csv('winter_group.csv', stringsAsFactors = FALSE, check.names = FALSE)
