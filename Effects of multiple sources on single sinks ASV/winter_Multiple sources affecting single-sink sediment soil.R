...
soil.source=S.soil %>%select("winter_C_M1") 
soil.sink=S.soil %>%select("winter_C_M2") 
...
soil.source=S.soil %>%select("winter_C_M2") 
soil.sink=S.soil %>%select("winter_C_M3") 
...
soil.source=S.soil %>%select("winter_C_M3") 
soil.sink=S.soil %>%select("winter_C_M4") 
...
soil.source=S.soil %>%select("winter_C_M4") 
soil.sink=S.soil %>%select("winter_C_M5") 
...
soil.source=S.soil %>%select("winter_C_M5") 
soil.sink=S.soil %>%select("winter_C_M6") 
...
soil.source=S.soil %>%select("winter_C_M6") 
soil.sink=S.soil %>%select("winter_C_M7") 
...
soil.source=S.soil %>%select("winter_C_M7") 
soil.sink=S.soil %>%select("winter_C_M8") 
...
biofilm=S.biofilm%>%select("winter_B_JH4") 
water=S.water%>%select("winter_W_JH4") 
soil.source=S.soil %>%select("winter_C_JH4") 
soil.sink=S.soil %>%select("winter_C_M8") 
...
soil.source=S.soil %>%select("winter_C_M8") 
soil.sink=S.soil %>%select("winter_C_M9") 
...
biofilm=S.biofilm%>%select("winter_B_ZSH") 
water=S.water%>%select("winter_W_ZSH") 
soil.source=S.soil %>%select("winter_C_ZSH") 
soil.sink=S.soil %>%select("winter_C_M9") 
...
soil.source=S.soil %>%select("winter_C_M9") 
soil.sink=S.soil %>%select("winter_C_M10") 
...
soil.source=S.soil %>%select("winter_C_M10") 
soil.sink=S.soil %>%select("winter_C_M11") 
...
soil.source=S.soil %>%select("winter_C_M11") 
soil.sink=S.soil %>%select("winter_C_M12") 
...
soil.source=S.soil %>%select("winter_C_M12") 
soil.sink=S.soil %>%select("winter_C_M13") 
...
soil.source=S.soil %>%select("winter_C_QYH4") 
soil.sink=S.soil %>%select("winter_C_M13") 
...
soil.source=S.soil %>%select("winter_C_JH1") 
soil.sink=S.soil %>%select("winter_C_JH2") 
...
soil.source=S.soil %>%select("winter_C_QYH1") 
soil.sink=S.soil %>%select("winter_C_QYH2") 
...
soil.source=S.soil %>%select("winter_C_QYH2") 
soil.sink=S.soil %>%select("winter_C_QYH3") 
...
soil.source=S.soil %>%select("winter_C_QYH3") 
soil.sink=S.soil %>%select("winter_C_QYH4") 
