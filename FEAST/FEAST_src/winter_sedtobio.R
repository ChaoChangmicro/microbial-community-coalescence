...
#  1
metadata <- read.csv("../V9/group/winter_sedtobio.csv",header = T, sep = ",", row.names = 1)
# Load OTU table
otus <- read.table("../V9/input/winter_biofilm_sediment.csv",header = T, sep = ",", row.names = 1)
...
write.csv(Proportions_est,file = "winter_sedtobio.res.csv",quote=F)