...
#  1
metadata <- read.csv("../V9/group/summer_wtobio.csv",header = T, sep = ",", row.names = 1)
# Load OTU table
otus <- read.table("../V9/input/summer_biofilm_water.csv",header = T, sep = ",", row.names = 1)
...
write.csv(Proportions_est,file = "summer_wtobio.res.csv",quote=F)