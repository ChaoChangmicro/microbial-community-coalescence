...
#  1
metadata <- read.csv("../V9/group/summer_stobio.csv",header = T, sep = ",", row.names = 1)
# Load OTU table
otus <- read.table("../V9/input/summer_soil_biofilm.csv",header = T, sep = ",", row.names = 1)
...
write.csv(Proportions_est,file = "summer_stobio.res.csv",quote=F)