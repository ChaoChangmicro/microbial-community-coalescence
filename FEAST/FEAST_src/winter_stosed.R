...
#  1
metadata <- read.csv("../V9/group/winter_stosed.csv",header = T, sep = ",", row.names = 1)
# Load OTU table
otus <- read.table("../V9/input/winter_sediment_soil.csv",header = T, sep = ",", row.names = 1)
...
write.csv(Proportions_est,file = "winter_stosed.res.csv",quote=F)