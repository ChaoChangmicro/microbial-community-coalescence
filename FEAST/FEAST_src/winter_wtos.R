...
#  1
metadata <- read.csv("../V9/group/winter_wtos.csv",header = T, sep = ",", row.names = 1)
# Load OTU table
otus <- read.table("../V9/input/winter_soil_water.csv",header = T, sep = ",", row.names = 1)
...
write.csv(Proportions_est,file = "winter_wtos.res.csv",quote=F)