...
#  1
metadata <- read.csv("../V9/group/winter_biotow.csv",header = T, sep = ",", row.names = 1)
# Load OTU table
otus <- read.table("../V9/input/winter_biofilm_water.csv",header = T, sep = ",", row.names = 1)
...
write.csv(Proportions_est,file = "winter_biotow.res.csv",quote=F)