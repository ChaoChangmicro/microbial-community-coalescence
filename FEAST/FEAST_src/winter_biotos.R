...
#  1
metadata <- read.csv("../V9/group/winter_biotos.csv",header = T, sep = ",", row.names = 1)
# Load OTU table
otus <- read.table("../V9/input/winter_biofilm_soil.csv",header = T, sep = ",", row.names = 1)
...
write.csv(Proportions_est,file = "winter_biotos.res.csv",quote=F)