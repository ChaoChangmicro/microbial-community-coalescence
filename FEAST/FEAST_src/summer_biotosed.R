...
#  1
metadata <- read.csv("../V9/group/summer_biotosed.csv",header = T, sep = ",", row.names = 1)
# Load OTU table
otus <- read.table("../V9/input/summer_biofilm_sediment.csv",header = T, sep = ",", row.names = 1)
...
write.csv(Proportions_est,file = "summer_biotosed.res.csv",quote=F)