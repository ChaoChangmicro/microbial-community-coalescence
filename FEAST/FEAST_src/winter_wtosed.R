...
#  1
metadata <- read.csv("../V9/group/winter_wtosed.csv",header = T, sep = ",", row.names = 1)
# Load OTU table
otus <- read.table("../V9/input/winter_sediment_water.csv",header = T, sep = ",", row.names = 1)
...
write.csv(Proportions_est,file = "winter_wtosed.res.csv",quote=F)